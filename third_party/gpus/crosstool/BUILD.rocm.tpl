...
cc_toolchain(
    ...
    all_files = ":crosstool_wrapper_driver_is_clang_for_hip",
    compiler_files = ":crosstool_wrapper_driver_is_clang_for_hip",
    ar_files = ":crosstool_wrapper_driver_is_clang_for_hip",
    as_files = ":crosstool_wrapper_driver_is_clang_for_hip",
    dwp_files = ":empty",
    linker_files = ":crosstool_wrapper_driver_is_clang_for_hip",
    objcopy_files = ":empty",
    strip_files = ":empty",
