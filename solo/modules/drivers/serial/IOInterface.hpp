...
public:
  ...
  virtual std::tuple<Status, std::optional<T>> read(const std::string& request)
  = 0;
...
protected:
  ...
  ///< Indicates whether the connection or file has been initialized.
  bool isOpened_{false};
  ///< Indicates whether the connection or file is currently open.
