...
struct ImFontAtlas
{
    ...
    unsigned int                FontBuilderFlags;   // Shared flags (for all fonts) for custom font builder. THIS IS BUILD.bazel IMPLEMENTATION DEPENDENT. Per-font override is also available in ImFontConfig.
