...
export APOLLO_ENV_CONTAINER_REPO_X86='registry.baidubce.com/apollo/apollo-dev-gpu'
...
#export APOLLO_ENV_CONTAINER_IMAGE="registry.baidubce.com/apollo/apollo-dev-gpu:10.0-u22"
